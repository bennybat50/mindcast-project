              ...
              <div class="banner">
                <div class="row">
                  <div class="col-md-8">
                    <div class="set2">
                      ...
                      <p>
                        ...
                        well-being is more important than ever. Mindcast offers
                        a comprehensive mental health solution designed to
                        support your team’s mental wellness, reduce stress, and
                  ...
                  <div class="col-md-3">
                    <div class="set1">
                      <div class="top">
                        <img src="/image/business/business-1.png" alt="" />
                      </div>
                      <div class="bottom">
                        <div class="play">
                    ...
                    <div class="col-md-4 mb-5">
                      <div class="icon-bg">
                        <div class="text-center">
                          <br />
                          <img src="/image/business/headache-1.png" alt="" />
                          <br />
                          <br />
                          <p>
                    ...
                    <div class="col-md-4 mb-5">
                      <div style={{display: "flex", justifyContent: "center"}}>
                        ...
                        <div class="icon-bg">
                          <div class="text-center">
                            <br />
                            <img src="/image/business/headphone-1.png" alt="" />
                            <br />
                            <br />
                            <p>
                      ...
                      <div style={{display: "flex", justifyContent: "end"}}>
                        <div class="icon-bg">
                          ...
                          <div class="text-center">
                            <br />
                            <img
                              src="/image/business/check-list-1.png"
                              alt=""
                            />
                            <br />
                            <p>
              ...
              <div class="section2">
                <div class="text">
                  <div class="col-md-6">
                    ...
                    <p>
                      Happy and healthy employees are more productive and loyal.
                      With Mindcasts, your team will have access to tools and
                      resources to help them thrive both personally and
                      professionally.
                    </p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4 p-4">
                    <div class="set1">
                      <div class="top">
                        <img src="/image/business/business-4.png" alt="" />
                      </div>
                      <div class="bottom">
                        <div class="play">
                          <img src="/image/Group 2.png" alt="" />
                  ...
                  <div class="col-md-4 p-4">
                    <div class="set1">
                      <div class="top">
                        <img src="/image/business/business-2.png" alt="" />
                      </div>
                      <div class="bottom">
                        <div class="play">
                          <img src="/image/Group 2.png" alt="" />
                  ...
                  <div class="col-md-4 p-4">
                    <div class="set1">
                      <div class="top">
                        <img src="/image/business/business-3.png" alt="" />
                      </div>
                      <div class="bottom">
                        <div class="play">
                          <img src="/image/Group 2.png" alt="" />
              ...
              <div class="section1">
                <div class="row">
                  <div class="col-md-4">
                    <div class="set1">
                      <div class="top">
                        <img src="/image/business/business-5.png" alt="" />
                      </div>
                      <div class="bottom">
                        <div class="play">
                          <img src="/image/Group 2.png" alt="" />
                  ...
                  <div class="col-md-7">
                    <div class="set2">
                      ...
                      <p>
                        By joining Mindcasts, your company will not only see an
                        improvement in employee well-being but also in overall
                        ...
                        <div class="col-md-7 ">
                          <div class="benfit-bg">
                            <div class="text-center">
                              ...
                              <br />
                              <p>
                                Companies that prioritise employee wellness are
                                viewed more favourably by clients, partners, and
                                potential hires.
                              </p>
                            </div>
                          </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pt-5">
                      <div class="text">
                        ...
                        <p>
                          Join the growing number of companies that are taking a
                          proactive approach to mental health. With Mindcasts,
                          you're not just investing in your employees – you're
